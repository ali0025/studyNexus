...
function Navbar() {
    ...
    return (
        <div className='flex h-14 items-center justify-center border-b-[1px] border-b-richblack-700 bg-richblack-900 z-[9999] relative'>
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                {/* logo */}
                <Link to="/">
                    <img src={img} alt="Logo" width={160} height={32} loading="lazy" />
                </Link>
            ...
            {/* Mobile menu */}
            {isMenuOpen && (
                <div className="absolute top-14 left-0 w-full bg-richblack-900 px-4 py-4 md:hidden z-50 border-t border-richblack-700">
